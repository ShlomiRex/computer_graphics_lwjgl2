...
public class OBJLoader extends Object {
    ...
    public int createDisplayList(RawModel model) {
    ...
    /**
     * Renders a given <code>RawModel</code> file.
     *
    ...
    public RawModel loadModel(String fileName) throws FileNotFoundException {
        File file = new File(fileName);
        RawModel model = loadModel(file);
        return model;
    }

    /**
     * @param file the file to be loaded
     * @return the loaded <code>RawModel</code>
     * @throws java.io.FileNotFoundException thrown if the Obj file is not found
     */
    public RawModel loadModel(File file) throws FileNotFoundException {
     ...
     */
    public RawModel loadModel(InputStream stream) {
     ...
     * @return the loaded <code>Obj</code>
     */
    public RawModel loadModel(Scanner sc) {
            ...
            if (ln == null || ln.equals("") || ln.startsWith("#")) {
                ...
                switch (split[0]) {
                    ...
                    case "vt":
                        ...
                        break;
                    case "f":
                        model.getFaces().add(new RawModel.Face(
                                new int[]{
